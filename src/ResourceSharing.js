...
// function ResourceSharing({ players, onShare }) {
...
//   const handleShare = () => {
//     if (fromPlayerId && toPlayerId && resourceType && amount > 0) {
//       onShare(Number(fromPlayerId), Number(toPlayerId), resourceType, Number(amount));
//       setAmount(0);
//     }
//   };
...
//         <label>
//           From Player:
//           <select value={fromPlayerId} onChange={(e) => setFromPlayerId(e.target.value)}>
